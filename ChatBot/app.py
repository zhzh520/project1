...
# ====================== 自动场景识别关键词 ======================
CIVIL_KEYWORDS = [
    "借钱", "欠钱", "借条", "欠条", "转账", "债务", "还款", "逾期", "利息",
    "彩礼", "嫁妆", "离婚", "复婚", "抚养权", "抚养费", "探视权", "财产分割",
    "房产", "买房", "卖房", "租房", "房东", "租客", "押金", "租金",
    "交通事故", "全责", "追尾", "赔偿", "医疗费", "误工费",
    "合同", "违约", "买卖", "租赁", "借款合同", "合作协议",
    "继承", "遗嘱", "遗产", "赠与", "欠款", "借贷", "高利贷",
    "肖像权", "名誉权", "隐私", "侵权", "人身损害", "精神损害",
    "相邻权", "宅基地", "装修", "物业", "物业费", "邻居纠纷"
]

CRIMINAL_KEYWORDS = [
    "盗窃", "诈骗", "电信诈骗", "网络诈骗", "轻伤", "重伤", "拘留",
    "逮捕", "取保", "取保候审", "监视居住", "缓刑", "假释", "减刑",
    "坐牢", "判刑", "立案", "罪名", "故意伤害", "抢劫", "抢夺",
    "强奸", "猥亵", "贪污", "受贿", "挪用公款", "帮信", "掩饰隐瞒",
    "敲诈勒索", "寻衅滋事", "非法拘禁", "危险驾驶", "酒驾", "醉驾",
    "聚众斗殴", "贩毒", "走私", "偷渡", "自首", "立功", "累犯",
    "在逃", "通缉", "刑拘", "批捕", "公诉", "开庭", "刑期","撞死"
]

LABOR_KEYWORDS = [
    "工资", "拖欠工资", "不发工资", "克扣工资", "辞退", "解雇", "开除",
    "裁员", "被迫离职", "加班", "加班费", "夜班", "社保", "五险一金",
    "工伤", "工亡", "伤残", "工伤认定", "劳动能力鉴定",
    "劳动合同", "未签合同", "双倍工资", "试用期", "转正",
    "仲裁", "劳动仲裁", "赔偿金", "经济补偿", "N+1", "2N", "N",
    "违法解除", "调岗", "降薪", "工地", "农民工", "欠薪",
    "离职证明", "竞业限制", "保密协议", "加班费", "年假"
]
...
def chat():
    ...
    legal_keywords = [
        ...
        "管辖权异议", "举证期限", "财产保全", "先予执行", "再审申请","隐匿转移财产","取证","赔钱"
        # 刑事诉讼与治安
